<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormResultado.aspx.cs" Inherits="WebApplication5.WebFormResultado" %>
...
<body>
    <div id="wrap">
        ...
        <div id="main">
            ...
            <asp:Label runat="server" id="txtPesquisa" Text=""/>
            <asp:DataGrid runat="server" ID="dgResultado" />
            </div>
        </div>
    </div>
        <div class="footer">

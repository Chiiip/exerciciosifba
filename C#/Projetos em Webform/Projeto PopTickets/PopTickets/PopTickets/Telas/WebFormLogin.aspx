<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormLogin.aspx.cs" Inherits="PopTickets.Telas.WebFormLogin" %>
...
<body>
    <div id="wrap">
        ...
        <div id="main">
            ...
            <asp:Button runat="server" ID="btnCadastro" Text="Não tenho conta" OnClick="btnCadastro_Click"/><br />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormCadastroEvento.aspx.cs" Inherits="PopTickets.Telas.WebFormCadastroEvento" %>
...
<body>
 ...
 <div id="main">
            ...
            <asp:Label runat="server" id="lblNomeEvento" Text="Nome do Evento"/>
            <asp:TextBox runat="server" ID="txtNomeEvento" /><br/>
            <asp:Label runat="server" id="lblData" Text="Data do Evento"/>
            <asp:TextBox runat="server" ID="txtDataEvento" /><br/>
            <asp:Label runat="server" id="lblTipoEvento" Text="Tipo de Evento"/>
            <asp:TextBox runat="server" ID="txtTipo" /><br/>
            <asp:Label runat="server" id="lblEmpresa" Text="Empresa"/>
            <asp:DropDownlist runat="server" ID="ddlEmpresaEvento" /><br/>
            <asp:Label runat="server" id="lblLocalEvento" Text="Endereço"/>
            <asp:DropDownList runat="server" ID="ddlLocalEvento" /><br/><br/>
            ...
            <asp:Label runat="server" id="txtEventosCadastrados" Text=""/>
            <asp:DataGrid runat="server" ID="dgEventosCadastrados" 
                OnDeleteCommand="dgEventosCadastrados_DeleteCommand" 
                OnSelectedIndexChanged="dgEventosCadastrados_SelectedIndexChanged" 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormDados.aspx.cs" Inherits="PopTickets.Telas.WebFormDados" %>
    ...
    <div id="wrap">
       <div class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div id="main">
            ...
            <asp:Button runat="server" ID="btnVoltar" Text="Voltar" OnClick="btnVoltar_Click"/><br />

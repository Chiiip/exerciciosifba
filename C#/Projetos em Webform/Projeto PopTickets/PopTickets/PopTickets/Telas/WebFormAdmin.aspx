<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormAdmin.aspx.cs" Inherits="PopTickets.Telas.WebFormAdmin" %>
...
<body>
    <div id="wrap">
        ...
        <div id="main">
            ...
            <asp:Button runat="server" ID="btnEmpresa" Text="Gerenciar Empresas" CssClass="botao2" OnClick="btnEmpresa_Click"/>
            <asp:Button runat="server" ID="btnEvento" Text="Gerenciar Eventos" CssClass="botao2" OnClick="btnEvento_Click"/>
            <asp:Button runat="server" ID="btnLocal" Text="Gerenciar Locais" CssClass="botao2" OnClick="btnLocal_Click"/>
                <asp:Button runat="server" ID="btnSetor" Text="Gerenciar Setores" CssClass="botao2" OnClick="btnSetor_Click"/>
            </form>
            </div>
        </div>
    </div>

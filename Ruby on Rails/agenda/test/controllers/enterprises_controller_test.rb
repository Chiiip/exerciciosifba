...
class EnterprisesControllerTest < ActionController::TestCase
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post :create, enterprise: { address: @enterprise.address, fantasyname: @enterprise.fantasyname, fone: @enterprise.fone, obs: @enterprise.obs }
    end
  ...
  test "should update enterprise" do
    patch :update, id: @enterprise, enterprise: { address: @enterprise.address, fantasyname: @enterprise.fantasyname, fone: @enterprise.fone, obs: @enterprise.obs }
    assert_redirected_to enterprise_path(assigns(:enterprise))
  end

...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { email: @professor.email, name: @professor.name, password: @professor.password, phone: @professor.phone }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { email: @professor.email, name: @professor.name, password: @professor.password, phone: @professor.phone }
    assert_redirected_to professor_path(assigns(:professor))
  end
